...
--
-- Host: localhost
-- Generation Time: Mar 18, 2018 at 10:58 PM
...
INSERT INTO `BITACORA` (`ID_BITACORA`, `ID_USUARIO_BITACORA`, `DESCRIPCION_BITACORA`, `FECHA_BITACORA`) VALUES
(1, 666, 'Prueba', '2018-03-18 23:12:55');

-- --------------------------------------------------------

--
-- Table structure for table `CATALOGO_BIENES_SERVICIOS`
--

CREATE TABLE IF NOT EXISTS `CATALOGO_BIENES_SERVICIOS` (
  `ID_BIENES_SERVICIOS` varchar(1) COLLATE utf8_spanish_ci NOT NULL,
  `DESCRIPCION_BIENES_SERVICIOS` varchar(20) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Dumping data for table `CATALOGO_BIENES_SERVICIOS`
--

INSERT INTO `CATALOGO_BIENES_SERVICIOS` (`ID_BIENES_SERVICIOS`, `DESCRIPCION_BIENES_SERVICIOS`) VALUES
('M', 'Medicamentos'),
('P', 'Productos'),
('S', 'Servicios');
...
CREATE TABLE IF NOT EXISTS `CATALOGO_MEDICAMENTOS` (
  `ID_MEDICAMENTO` varchar(1) COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Dumping data for table `CATALOGO_MEDICAMENTOS`
--

INSERT INTO `CATALOGO_MEDICAMENTOS` (`ID_MEDICAMENTO`, `CODIGO_MEDICAMENTO`, `NOMBRE_MEDICAMENTO`, `SUSTANCIA_MEDICAMENTO`, `FARMACEUTICA_MEDICAMENTO`, `PRESENTACION_MEDICAMENTO`, `DESCRIPCION_MEDICAMENTO`, `NUMERO_MAXIMO_MEDICAMENTO`, `NUMERO_MINIMO_MEDICAMENTO`) VALUES
('M', 564, 'Medicamento 1', 'Sustancia 1', 'Farmaceutica 1', 'Presentacion 1', 'Descripcion 1', 6, 1);
...
INSERT INTO `CATALOGO_PRODUCTOS` (`ID_PRODUCTO`, `CODIGO_PRODUCTO`, `NOMBRE_PRODUCTO`, `MARCA_PRODUCTO`, `PRESENTACION_PRODUCTO`, `DESCRIPCION_PRODUCTO`, `NUMERO_MAXIMO_PRODUCTO`, `NUMERO_MINIMO_PRODUCTO`) VALUES
('P', 3212, 'Nombre 1', 'Marca 1', 'Presentacion 1', 'Descripcion de Producto', 66, 4);
...
INSERT INTO `CATALOGO_SERVICIOS` (`ID_SERVICIO`, `CODIGO_SERVICIO`, `NOMBRE_SERVICIO`, `DESCRIPCION_SERVICIO`) VALUES
('S', 4323, 'Servicio 1', 'Descripcion del Servicio');
...
INSERT INTO `HISTORICO_VENTAS` (`ID_VENTA`, `ID_USUARIO_VENTA`, `CODIGO_VENTA`, `CANTIDAD_VENTA`, `FECHA_VENTA`, `ESTATUS_PRODUCTO_VENTA`, `CLIENTE_VENTA`, `DESCUENTO_VENTA`) VALUES
(1, 666, 524, 54.00, '2018-03-19 00:53:06', 'C', 1, 1);
...
CREATE TABLE IF NOT EXISTS `INVENTARIO_ALMACEN` (
  ...
  `FECHA_CADUCIDAD_INVENTARIO` timestamp NULL DEFAULT NULL,
...
INSERT INTO `INVENTARIO_ALMACEN` (`ID_TIPO_INVENTARIO`, `CODIGO_INVENTARIO`, `FECHA_INGRESO_INVENTARIO`, `CANTIDAD_INVENTARIO`, `FECHA_CADUCIDAD_INVENTARIO`, `LOTE_INVENTARIO`) VALUES
('M', 45645, '2018-03-19 03:45:11', 5, NULL, 445);
...
`ID_PARCIALIDAD` int(11) NOT NULL,
  ...
  `FECHA_PARCIALIDAD` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 1, 1, 12.56, '2018-03-19 00:53:42');
...
--
-- Indexes for table `CATALOGO_BIENES_SERVICIOS`
--
ALTER TABLE `CATALOGO_BIENES_SERVICIOS`
 ADD PRIMARY KEY (`ID_BIENES_SERVICIOS`);
...
ALTER TABLE `CATALOGO_MEDICAMENTOS`
 ADD PRIMARY KEY (`ID_MEDICAMENTO`), ADD UNIQUE KEY `CODIGO_MEDICAMENTO` (`CODIGO_MEDICAMENTO`);
...
ALTER TABLE `CATALOGO_SERVICIOS`
 ADD PRIMARY KEY (`ID_SERVICIO`), ADD UNIQUE KEY `CODIGO_SERVICIO` (`CODIGO_SERVICIO`);
...
ALTER TABLE `PARCIALIDADES`
 ADD PRIMARY KEY (`ID_PARCIALIDAD`,`ID_PARCIALIDAD_VENTA`), ADD KEY `ID_PARCIALIDAD_VENTA` (`ID_PARCIALIDAD_VENTA`);
...
--
-- AUTO_INCREMENT for table `PARCIALIDADES`
--
ALTER TABLE `PARCIALIDADES`
MODIFY `ID_PARCIALIDAD` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- Constraints for table `CATALOGO_MEDICAMENTOS`
--
ALTER TABLE `CATALOGO_MEDICAMENTOS`
ADD CONSTRAINT `CATALOGO_MEDICAMENTOS_ibfk_1` FOREIGN KEY (`ID_MEDICAMENTO`) REFERENCES `CATALOGO_BIENES_SERVICIOS` (`ID_BIENES_SERVICIOS`);

--
-- Constraints for table `CATALOGO_PRODUCTOS`
--
ALTER TABLE `CATALOGO_PRODUCTOS`
ADD CONSTRAINT `CATALOGO_PRODUCTOS_ibfk_1` FOREIGN KEY (`ID_PRODUCTO`) REFERENCES `CATALOGO_BIENES_SERVICIOS` (`ID_BIENES_SERVICIOS`);

--
-- Constraints for table `CATALOGO_SERVICIOS`
--
ALTER TABLE `CATALOGO_SERVICIOS`
ADD CONSTRAINT `CATALOGO_SERVICIOS_ibfk_1` FOREIGN KEY (`ID_SERVICIO`) REFERENCES `CATALOGO_BIENES_SERVICIOS` (`ID_BIENES_SERVICIOS`);
...
--
ALTER TABLE `INVENTARIO_ALMACEN`
ADD CONSTRAINT `INVENTARIO_ALMACEN_ibfk_1` FOREIGN KEY (`ID_TIPO_INVENTARIO`) REFERENCES `CATALOGO_BIENES_SERVICIOS` (`ID_BIENES_SERVICIOS`);

--
-- Constraints for table `PARCIALIDADES`
--
ALTER TABLE `PARCIALIDADES`
ADD CONSTRAINT `PARCIALIDADES_ibfk_1` FOREIGN KEY (`ID_PARCIALIDAD_VENTA`) REFERENCES `HISTORICO_VENTAS` (`ID_VENTA`);
